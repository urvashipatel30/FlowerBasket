...
class MySwitchButton : View, Checkable {
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        if (widthMode == MeasureSpec.UNSPECIFIED
            ...
            widthMeasure = MeasureSpec.makeMeasureSpec(DEFAULT_WIDTH, MeasureSpec.EXACTLY)
        }
        if (heightMode == MeasureSpec.UNSPECIFIED
            || heightMode == MeasureSpec.AT_MOST
        ) {
            heightMeasure = MeasureSpec.makeMeasureSpec(DEFAULT_HEIGHT, MeasureSpec.EXACTLY)
        }
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        //Draw the border of the closed state
        ...
        //Draw the green strip on the left side of the button to block
...
//        paint.setStyle(Paint.Style.STROKE);
        ...
        if (isChecked()) {
            paint!!.color = checkedButtonColor
//            paint!!.color = Color.WHITE
        } else paint!!.color = uncheckButtonColor
     ...
     * 保存动画状态
     */
    private class ViewState constructor() {
        /**
