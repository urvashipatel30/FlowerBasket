...
class SwipeDashboardActivity : ParentActivity() {

    private lateinit var activity: Activity
    private lateinit var binding: ActivitySwipeDashboardBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivitySwipeDashboardBinding.inflate(layoutInflater)
        setContentView(binding.root)

        activity = this@SwipeDashboardActivity
